...
old_user_profile_table = "event_sink.old_user_profile"
...
def upgrade():
    ...
    op.execute(
        f"""
        RENAME TABLE event_sink.user_profile
    ...
    op.execute(
        f"""
        CREATE OR REPLACE TABLE event_sink.user_profile
        {on_cluster}
        (
            id Int32 NOT NULL,
    ...
    op.execute(
        f"""
        INSERT INTO event_sink.user_profile
